...
while($row=mysqli_fetch_array($result)) {
    ...
    ?>
    <!--<input type="text" id="lat" value="<?php $row[0];?>">
    <input type="text" id="long" value="<?php $row[1];?>">-->
<?php
}
?>
<script>
    ...
    function getPoints() {
        ...
        for(j=0;j<10000;j++)
        {
            i.push(37+j/100000);
            k.push(76+j/100000);
            var str1='new google.maps.LatLng('+(37+j/100000)+','+(76+j/100000)+')';
            alert(str1);
            str.push(str1);
        ...
        return [
            ...
            //new google.maps.LatLng(x.value, y.value)
        ];
    }
